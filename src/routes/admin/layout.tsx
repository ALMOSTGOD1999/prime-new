...
function AdminLayout() {
  ...
  const navLinks = [
    ...
    { to: "/admin/income", label: "Income", icon: "◆" },
      ...
      >
        <div className="flex h-full flex-col">
          <div className="border-b border-cream/10 p-6">
            ...
            <p className="mt-2 inline-block rounded bg-gold/20 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-widest text-gold">
              Admin Panel
            </p>
          </div>
